...
module.exports = {
    createverifyElder: (data, callBack) => {
        pool.query(
            `INSERT INTO verification_of_elders(elder_id,gramaniladari_id,divisional_officer_id,divisional_head_id,gramaniladari_comment,divisional_officers_comment,divisional_head_comment,validity_by_gramaniladari,validity_by_divisional_officer,validity_by_divisional_head) VALUES (?,?,?,?,?,?,?,?,?,?)`,
            [
                data.elder_id,
    ...
    updateverifyElder: (data, callBack) => {
        pool.query(
          `UPDATE verification_of_elders SET gramaniladari_id=?,divisional_officer_id=?,divisional_head_id=?,gramaniladari_comment=?,divisional_officers_comment=?,divisional_head_comment=?,validity_by_gramaniladari=?,validity_by_divisional_officer=?,validity_by_divisional_head=? WHERE elder_id=?`,
          [
            data.gramaniladari_id,
            data.divisional_officer_id,
            data.divisional_head_id,
